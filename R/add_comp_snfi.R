...
#' and functional disability scale (FDS) indicators. It also determines if a
#' household is in need or in severe need based on the calculated score.
#'
...
#' @param tenure_security_cat_high_risk Level for high risk with security of
#'   tenure.
#' @param tenure_security_cat_medium_risk Level for medium risk with security
#'   of tenure.
#' @param tenure_security_cat_low_risk Level for low risk with security of
#'   tenure.
#' @param tenure_security_cat_undefined Level for undefined with security of
#'   tenure.
...
#' @param shelter_damage_cat_undefined Level name for undefined or unknown
#'   status for shelter damage.
#'
...
add_comp_snfi <- function(
  ...
  # Compute total score = max of all component scores
  comp_vars <- c(
