...
add_comp_wash <- function(
  ...
  are_values_in_set(df, drinking_water_quality_jmp_cat, c(drinking_water_quality_jmp_cat_surface_water, drinking_water_quality_jmp_cat_unimproved, drinking_water_quality_jmp_cat_limited, drinking_water_quality_jmp_cat_basic, drinking_water_quality_jmp_cat_safely_managed, drinking_water_quality_jmp_cat_undefined))
  are_values_in_set(df, sanitation_facility_jmp_cat, c(sanitation_facility_jmp_cat_open_defecation, sanitation_facility_jmp_cat_unimproved, sanitation_facility_jmp_cat_limited, sanitation_facility_jmp_cat_basic, sanitation_facility_jmp_cat_safely_managed, sanitation_facility_jmp_cat_undefined))
  are_values_in_set(df, sanitation_facility_cat, c(sanitation_facility_cat_none, sanitation_facility_cat_unimproved, sanitation_facility_cat_improved, sanitation_facility_cat_undefined))
  are_values_in_set(df, sanitation_facility_n_ind, c(sanitation_facility_n_ind_50_and_above, sanitation_facility_n_ind_20_to_49, sanitation_facility_n_ind_19_and_below))
  are_values_in_set(df, handwashing_facility_jmp_cat, c(handwashing_facility_jmp_cat_no_facility, handwashing_facility_jmp_cat_limited, handwashing_facility_jmp_cat_basic, handwashing_facility_jmp_cat_undefined))
  are_values_in_set(df, sharing_sanitation_facility_cat, c(sharing_sanitation_facility_cat_shared, sharing_sanitation_facility_cat_not_shared, sharing_sanitation_facility_cat_not_applicable, sharing_sanitation_facility_cat_undefined))
  ...
  df <- dplyr::mutate(
    ...
    comp_wash_score_water_quality = dplyr::case_when(
      ...
      !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_safely_managed ~ 1,
      # Camp
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_surface_water ~ 5,
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_unimproved ~ 4,
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_limited ~ 3,
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_basic ~ 2,
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_undefined ~ NA_real_,
      # Urban
      !!rlang::sym(setting) == setting_urban & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_surface_water ~ 4,
      !!rlang::sym(setting) == setting_urban & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_unimproved ~ 3,
      !!rlang::sym(setting) == setting_urban & !!rlang::sym(drinking_water_quality_jmp_cat) %in% c(drinking_water_quality_jmp_cat_limited, drinking_water_quality_jmp_cat_basic) ~ 2,
      !!rlang::sym(setting) == setting_urban & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_undefined ~ NA_real_,
      # Rural
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_surface_water ~ 4,
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(drinking_water_quality_jmp_cat) %in% c(drinking_water_quality_jmp_cat_unimproved, drinking_water_quality_jmp_cat_limited) ~ 2,
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_basic ~ 1,
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(drinking_water_quality_jmp_cat) %in% drinking_water_quality_jmp_cat_undefined ~ NA_real_,
      # Default
      .default = NA_real_
    ),
    comp_wash_score_sanitation = dplyr::case_when(
      ...
      # - Open defecation
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_none ~ 5,
      # - Unimproved
      !!rlang::sym(setting) == setting_camp & !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_unimproved ~ 4,
      ...
      !!rlang::sym(setting) == setting_camp &
        ...
        !!rlang::sym(sanitation_facility_n_ind) == sanitation_facility_n_ind_50_and_above  ~ 4,
      # - Improved and shared with between 20 and 49 people
      !!rlang::sym(setting) == setting_camp &
        !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_improved &
        !!rlang::sym(sanitation_facility_n_ind) == sanitation_facility_n_ind_20_to_49  ~ 3,
      # - Improved and shared with less than 20 people
      !!rlang::sym(setting) == setting_camp &
        !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_improved &
        !!rlang::sym(sanitation_facility_n_ind) == sanitation_facility_n_ind_19_and_below &
        !!rlang::sym(sharing_sanitation_facility_cat) == sharing_sanitation_facility_cat_shared  ~ 2,
      # - Improved and not shared with people outside of the household
      !!rlang::sym(setting) == setting_camp &
        !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_improved &
        !!rlang::sym(sanitation_facility_n_ind) == sanitation_facility_n_ind_19_and_below &
        !!rlang::sym(sharing_sanitation_facility_cat) == sharing_sanitation_facility_cat_not_shared  ~ 1,
      # - Improved and "not applicable" for sharing with people outside of the household
      !!rlang::sym(setting) == setting_camp &
        !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_improved &
        !!rlang::sym(sharing_sanitation_facility_cat) == sharing_sanitation_facility_cat_not_applicable  ~ 1,
      # - Undefined
      !!rlang::sym(setting) == setting_camp &
        !!rlang::sym(sanitation_facility_cat) == sanitation_facility_cat_undefined ~ NA_real_,
      ...
      !!rlang::sym(setting) == setting_urban &
        ...
        !!rlang::sym(sanitation_facility_jmp_cat) == sanitation_facility_jmp_cat_open_defecation ~ 4,
      !!rlang::sym(setting) == setting_urban &
      ...
      !!rlang::sym(setting) == setting_rural &
        ...
        !!rlang::sym(sanitation_facility_jmp_cat) == sanitation_facility_jmp_cat_open_defecation ~ 4,
      !!rlang::sym(setting) == setting_rural &
        !!rlang::sym(sanitation_facility_jmp_cat) %in% c(sanitation_facility_jmp_cat_unimproved, sanitation_facility_jmp_cat_limited) ~ 2,
      !!rlang::sym(setting) == setting_rural &
        !!rlang::sym(sanitation_facility_jmp_cat) %in% c(sanitation_facility_jmp_cat_basic, sanitation_facility_jmp_cat_safely_managed) ~ 1,
      !!rlang::sym(setting) == setting_rural &
        !!rlang::sym(sanitation_facility_jmp_cat) == sanitation_facility_jmp_cat_undefined ~ NA_real_,
      # Default
      .default = NA_real_
    ...
    comp_wash_score_hygiene = dplyr::case_when(
      ...
      !!rlang::sym(setting) %in% c(setting_camp, setting_urban) & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_no_facility ~ 3,
      !!rlang::sym(setting) %in% c(setting_camp, setting_urban) & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_limited ~ 2,
      !!rlang::sym(setting) %in% c(setting_camp, setting_urban) & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_basic ~ 1,
      !!rlang::sym(setting) %in% c(setting_camp, setting_urban) & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_undefined ~ NA_real_,
      # Rural
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(handwashing_facility_jmp_cat) %in% c(handwashing_facility_jmp_cat_no_facility, handwashing_facility_jmp_cat_limited) ~ 2,
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_basic ~ 1,
      !!rlang::sym(setting) == setting_rural & !!rlang::sym(handwashing_facility_jmp_cat) == handwashing_facility_jmp_cat_undefined ~ NA_real_,
      .default = NA_real_
    )
  )
