...
df <- data.frame(
  ...
  wash_sanitation_facility_sharing_yn = c("yes", "no", "no", "dnk", "yes", "no"),
...
test_that("add_sanitation_facility_cat works correctly", {
  ...
  expect_equal(result$wash_sanitation_facility_cat, c("improved", "improved", "unimproved", "none", "undefined", "unimproved"))
})
...
test_that("add_sharing_sanitation_facility_cat works correctly", {
  ...
  expect_equal(result$wash_sharing_sanitation_facility_cat, c("shared", "not_shared", "not_shared", "undefined", "shared", "not_shared"))
})
...
test_that("add_sharing_sanitation_facility_num_ind works correctly", {
  ...
  expect_equal(result$wash_sharing_sanitation_facility_n_ind, c("20_to_49", "19_and_below", "19_and_below", NA, "20_to_49", "19_and_below"))
})
...
test_that("add_sanitation_facility_jmp_cat works correctly", {
  ...
  expect_equal(result$wash_sanitation_facility_jmp_cat, c("limited", "basic", "unimproved", "open_defecation", "undefined", "unimproved"))
})
