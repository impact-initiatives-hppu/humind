...
dummy_data <- data.frame(
  ...
  wash_drinking_water_jmp_cat = c("safely_managed", "basic", "limited", "unimproved"),
  ...
  wash_sanitation_facility_jmp_cat = c("basic", "limited", "no_facility", "undefined")
)
...
undefined_data <- data.frame(
  ...
  wash_drinking_water_jmp_cat = rep("undefined", 4),
...
na_data <- data.frame(
  ...
  wash_drinking_water_jmp_cat = c("safely_managed", NA, "limited", "unimproved"),
  ...
  wash_sanitation_facility_jmp_cat = c("basic", "limited", "no_facility", NA)
)
...
test_that("Function handles duplicated column names", {
  expect_error(add_comp_wash(duplicated_column_data), calss = "error")
})
