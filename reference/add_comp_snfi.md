...
composite score based on shelter type, shelter issues, security of
tenure, shelter damage, and functional disability scale (FDS)
indicators. It also determines if a household is in need or in severe
need based on the calculated score.
...
add_comp_snfi(
  ...
  tenure_security_cat = "hlp_tenure_security",
