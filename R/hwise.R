...
#'
#' @export
hwise <- function(df, hwise_worry, hwise_interrupt, hwise_clothes, hwise_plans, hwise_food, hwise_hands, hwise_body, hwise_drink, hwise_angry, hwise_sleep, hwise_none, hwise_shame, level_codes){
