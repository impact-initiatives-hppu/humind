...
test_that("add_expenditure_type_zero_freq function works with default parameters", {
  ...
  expect_equal(result$cm_expenditure_frequent_food[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_food[4], 100)
  expect_equal(result$cm_expenditure_frequent_rent[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_rent[4], 200)
  expect_equal(result$cm_expenditure_frequent_water[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_water[4], 50)
  expect_equal(result$cm_expenditure_frequent_nfi[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_nfi[4], 80)
  expect_equal(result$cm_expenditure_frequent_utilitiues[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_utilitiues[4], 60)
  expect_equal(result$cm_expenditure_frequent_fuel[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_fuel[4], 40)
  expect_equal(result$cm_expenditure_frequent_transportation[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_transportation[4], 30)
  expect_equal(result$cm_expenditure_frequent_communication[1:3], c(0, 0, 0))
  expect_equal(result$cm_expenditure_frequent_communication[4], 20)
  expect_equal(result$cm_expenditure_frequent_other[1:3], c(0, 0, 0))
...
test_that("add_expenditure_type_zero_freq function does not alter non-skipped values", {
  ...
  expect_equal(result$cm_expenditure_frequent_food, c(NA, NA, NA, 100))
  expect_equal(result$cm_expenditure_frequent_rent, c(NA, NA, NA, 200))
  expect_equal(result$cm_expenditure_frequent_water, c(NA, NA, NA, 50))
  expect_equal(result$cm_expenditure_frequent_nfi, c(NA, NA, NA, 80))
  expect_equal(result$cm_expenditure_frequent_utilitiues, c(NA, NA, NA, 60))
  expect_equal(result$cm_expenditure_frequent_fuel, c(NA, NA, NA, 40))
  expect_equal(result$cm_expenditure_frequent_transportation, c(NA, NA, NA, 30))
  expect_equal(result$cm_expenditure_frequent_communication, c(NA, NA, NA, 20))
  expect_equal(result$cm_expenditure_frequent_other, c(NA, NA, NA, 10))
})
...
test_that("add_expenditure_type_zero_freq function handles undefined values correctly", {
  ...
  expect_equal(result$cm_expenditure_frequent_food[2:3], c(0, 0))
  expect_equal(result$cm_expenditure_frequent_food[4], 100)
})
