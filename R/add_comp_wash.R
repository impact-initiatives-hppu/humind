...
add_ <- function(
    ...
    sanitation_faciliy_cat = "wash_sanitation_facility_cat",
    sanitation_faciliy_cat_levels = c("none", "unimproved", "improved", "undefined"),
    ...
    df <- dplyr::mutate(
        ...
        comp_wash_sanitation = dplyr::case_when(
            ...
            # - Unimproved
            !!rlang::sym(setting) == setting_levels[1] & !!rlang::sym(sanitation_facility_cat_levels) == sanitation_facility_cat_levels[2] ~ 4,
            ...
            !!rlang::sym(setting) == setting_levels[2] &
                !!rlang::sym(sanitation_facility_cat_levels) == sanitation_facility_cat_levels[1] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[1] ~ 4,
            !!rlang::sym(setting) == setting_levels[2] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[2] ~ 3,
            !!rlang::sym(setting) == setting_levels[2] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[3:4] ~ 2,
            !!rlang::sym(setting) == setting_levels[2] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[5] ~ 1,
            !!rlang::sym(setting) == setting_levels[2] &
            ...
            !!rlang::sym(setting) == setting_levels[3] &
                ...
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[1] ~ 4,
            !!rlang::sym(setting) == setting_levels[3] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[2:3] ~ 2,
            !!rlang::sym(setting) == setting_levels[3] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[4:5] ~ 1,
            !!rlang::sym(setting) == setting_levels[3] &
                !!rlang::sym(drinking_water_jmp_cat_levels) == drinking_water_jmp_cat_levels[6] ~ NA_real_,
            # Default
            .default = NA_real_),
