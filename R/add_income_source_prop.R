...
add_income_source_prop <- function(
  ...
  if (is.null(income_source_support_friends_n) && is.null(income_source_support_friends_n){
      len_income_source <- 7
  } else if (!is.null(income_source_support_friends_n) && !is.null(income_source_support_friends_n){
      len_income_source <- 9
  } else if (is.null(income_source_support_friends_n) | !is.null(income_source_support_friends_n){
      len_income_source <- 9
  }
