...
Education access, disruption, and protection-barrier indicators, and the
...
Food consumption, coping strategies, and hunger scale indicators, and
the food security composite score.
...
Healthcare access and needs indicators, and the health composite score.
...
## Shelter, Settlement & NFI (SNFI)

Shelter type, damage, and occupancy indicators, and the SNFI composite
score.
...
Drinking water, sanitation, and hygiene indicators, and the WASH
composite score.
...
Protection risk and Washington Group indicators, and the protection
composite score.
...
Combines sectoral composite scores into the overall MSNI.
...
Income source and expenditure indicators.
...
Household composition, head of household, phone access, and assistance
indicators.
...
Generic building blocks used across sectors.
...
Unexported helpers, documented for contributors.
